...
class XLMConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_edit.XLMModel`.
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 30145):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.XLMModel`.
        ...
        summary_type (:obj:`string`, optional, defaults to "first"):
            ...
            :class:`~transformers_edit.XLMForSequenceClassification`.
