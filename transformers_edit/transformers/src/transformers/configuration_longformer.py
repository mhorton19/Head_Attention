...
class LongformerConfig(RobertaConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_edit.LongformerModel`.
    ...
    The :class:`~transformers_edit.LongformerConfig` class directly inherits :class:`~transformers_edit.RobertaConfig`.
