...
class MobileBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_edit.MobileBertModel`.
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 30522):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.MobileBertModel`.
        ...
        type_vocab_size (:obj:`int`, optional, defaults to 2):
            The vocabulary size of the `token_type_ids` passed into :class:`~transformers_edit.MobileBertModel`.
