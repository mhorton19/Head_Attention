        ...
        **kwargs
        ...
        Params:
            encoder_pretrained_model_name_or_path (:obj: `str`, `optional`, defaults to `None`):
                ...
                - a path to a `directory` containing model weights saved using :func:`~transformers_edit.PreTrainedModel.save_pretrained`, e.g.: ``./my_model_directory/encoder``.
            ...
            decoder_pretrained_model_name_or_path (:obj: `str`, `optional`, defaults to `None`):
                ...
                - a string with the `shortcut name` of a pre-trained model to load from cache or download, e.g.: ``bert-base-uncased``.
                - a string with the `identifier name` of a pre-trained model that was user-uploaded to our S3, e.g.: ``dbmdz/bert-base-german-cased``.
                - a path to a `directory` containing model weights saved using :func:`~transformers_edit.PreTrainedModel.save_pretrained`, e.g.: ``./my_model_directory/decoder``.
                - a path or url to a `tensorflow index checkpoint file` (e.g. `./tf_model/model.ckpt.index`). In this case, ``from_tf`` should be set to True and a configuration object should be provided as ``config`` argument. This loading path is slower than converting the TensorFlow checkpoint in a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.
        ...
        **kwargs,
        ...
        Args:
            input_ids (:obj:`torch.LongTensor` of shape :obj:`(batch_size, sequence_length)`):
                ...
                Indices can be obtained using :class:`transformers_edit.PretrainedTokenizer`.
                See :func:`transformers_edit.PreTrainedTokenizer.encode` and
                :func:`transformers_edit.PreTrainedTokenizer.convert_tokens_to_ids` for details.
