...
class ReformerConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_edit.ReformerModel`.
    ...
    Args:
        ...
        vocab_size (:obj:`int`, optional, defaults to 320):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.ReformerModel`.
