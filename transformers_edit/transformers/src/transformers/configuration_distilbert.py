...
class DistilBertConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_edit.DistilBertModel`.
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 30522):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.BertModel`.
        ...
        qa_dropout (:obj:`float`, optional, defaults to 0.1):
            ...
            :class:`~transformers_edit.DistilBertForQuestionAnswering`.
        seq_classif_dropout (:obj:`float`, optional, defaults to 0.2):
            The dropout probabilities used in the sequence classification and the multiple choice model
            :class:`~transformers_edit.DistilBertForSequenceClassification`.
