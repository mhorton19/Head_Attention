...
class BertSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        self.use_elementwise = config.use_elementwise
...
from transformers.GlobalLayers.ElementwiseBertSelfAttention import ElementwiseBertSelfAttention

class BertAttention(nn.Module):
    def __init__(self, config):
        super().__init__()
        if config.use_elementwise:
            self.self = ElementwiseBertSelfAttention(config)
        else:
