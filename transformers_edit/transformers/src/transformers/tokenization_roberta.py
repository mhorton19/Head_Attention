...
class RobertaTokenizer(GPT2Tokenizer):
    ...
    This tokenizer inherits from :class:`~transformers_edit.PreTrainedTokenizer` which contains most of the methods. Users
...
class RobertaTokenizerFast(GPT2TokenizerFast):
    ...
    This tokenizer inherits from :class:`~transformers_edit.PreTrainedTokenizerFast` which contains most of the methods. Users
    should refer to the superclass for more information regarding methods.
