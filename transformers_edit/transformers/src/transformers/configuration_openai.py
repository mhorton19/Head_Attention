...
class OpenAIGPTConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_edit.OpenAIGPTModel`.
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 40478):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.CTRLModel`.
        ...
        summary_type (:obj:`string`, optional, defaults to "cls_index"):
            ...
            :class:`~transformers_edit.OpenAIGPTDoubleHeadsModel`.
