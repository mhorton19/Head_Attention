...
class XLNetConfig(PretrainedConfig):
    """
    This is the configuration class to store the configuration of a :class:`~transformers_edit.XLNetModel`.
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 32000):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.XLNetModel`.
        ...
        summary_type (:obj:`string`, optional, defaults to "last"):
            ...
            :class:`~transformers_edit.XLNetForSequenceClassification` and :class:`~transformers_edit.XLNetForMultipleChoice`.
