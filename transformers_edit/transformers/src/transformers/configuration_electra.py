...
class ElectraConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a :class:`~transformers_edit.ElectraModel`.
    ...
    Configuration objects inherit from  :class:`~transformers_edit.PretrainedConfig` and can be used
    to control the model outputs. Read the documentation from  :class:`~transformers_edit.PretrainedConfig`
    ...
    Args:
        vocab_size (:obj:`int`, optional, defaults to 30522):
            ...
            can be represented by the `inputs_ids` passed to the forward method of :class:`~transformers_edit.ElectraModel`.
        ...
        type_vocab_size (:obj:`int`, optional, defaults to 2):
            The vocabulary size of the `token_type_ids` passed into :class:`~transformers_edit.ElectraModel`.
        ...
        summary_type (:obj:`string`, optional, defaults to "first"):
            ...
            :class:`~transformers_edit.ElectraForMultipleChoice`.
