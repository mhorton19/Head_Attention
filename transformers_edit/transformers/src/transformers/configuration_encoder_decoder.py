...
class EncoderDecoderConfig(PretrainedConfig):
    r"""
    :class:`~transformers_edit.EncoderDecoderConfig` is the configuration class to store the configuration of a `EncoderDecoderModel`.
    ...
    Configuration objects inherit from  :class:`~transformers_edit.PretrainedConfig`
    and can be used to control the model outputs.
    See the documentation for :class:`~transformers_edit.PretrainedConfig` for more information.
